...
public class GetPlaceByCity implements Runnable {
	private final Handler handlerReply;
	private final String cityID;
	static InputStream is = null;
	static String json = "";
	public GetPlaceByCity(Handler handlerReply, String cityID) {
		this.handlerReply = handlerReply;
		this.cityID = cityID;
	}

	@Override
	public void run() {
		String URL = "http://thegioiuudai.com.vn/apps/server.php/merchant/list?city=" + cityID;
		Log.d("MainFragment ====> URL", URL);
		try {
