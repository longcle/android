...
//	private List<Place> listPlace;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		cityChanged = getArguments().getBoolean("cityChanged");
	...
	private void makeHttpBannerRequest(){
		String Url = "http://thegioiuudai.com.vn/apps/server.php/site/banners/" + cityValueSelected;
	...
	private void makeHttpRequest() {
		if (DataRepository.listPlace == null || cityChanged == true) {
