...
//		lvPlaceSearch.setAdapter(mListPlaceAdapter);
		...
		btnSubmitSearch = (Button)v.findViewById(R.id.btnSubmitSearch);
		btnSubmitSearch.setOnClickListener(this);
	...
	private void makeSearchHttpRequest() {
		...
		if (!txtSearch.getText().toString().isEmpty()) {
			builder.appendQueryParameter("keyword", txtSearch.getText().toString());
		}
...
//		}
	...
	private void makeSearchKeywordHttpRequest() {
		String URL = "http://thegioiuudai.com.vn/apps/server.php/merchant/list";
		Uri.Builder builder = Uri.parse(URL).buildUpon();
		if(!txtCitySearch.getText().toString().isEmpty()){
			builder.appendQueryParameter("city", cityValueSelected);
		}
		if(!txtDistrictSearch.getText().toString().isEmpty()){
			builder.appendQueryParameter("district", districtValueSelected);
		}
		if (!txtSearch.getText().toString().isEmpty()) {
			builder.appendQueryParameter("keyword", txtSearch.getText().toString());
